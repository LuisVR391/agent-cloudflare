...
| [Servicios, pipeline y oportunidades](./modules/pipelines.md) | En elaboración | [#36](https://github.com/LuisVR391/agent-cloudflare/issues/36) | Servicios, pipeline y etapas vigentes; oportunidades pendientes |
