...
| Servicios, pipeline y oportunidades | En progreso | Contactos de #34 | [Issue #36](https://github.com/LuisVR391/agent-cloudflare/issues/36) y [ADR-0010](../decisions/ADR-0010-crm-commercial-model.md); catálogo de servicios entregado en el [módulo de pipelines](../modules/pipelines.md) |
