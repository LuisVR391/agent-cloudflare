...
| Autenticación, roles y aislamiento multiempresa | En progreso | D1 y migraciones de #5 | [Issue #6](https://github.com/LuisVR391/agent-cloudflare/issues/6), implementación y [ADR-0007](../decisions/ADR-0007-better-auth-and-organization-context.md) pendientes de fusionar |
