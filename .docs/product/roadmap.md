...
| D1, migraciones y pruebas locales multiempresa | En progreso | Reglas y ADRs de #4 | [Issue #5](https://github.com/LuisVR391/agent-cloudflare/issues/5) y [ADR-0006](../decisions/ADR-0006-d1-schema-conventions.md) |
