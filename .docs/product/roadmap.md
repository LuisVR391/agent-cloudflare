...
| Servicios, pipeline y oportunidades | En progreso | Contactos de #34 | [Issue #36](https://github.com/LuisVR391/agent-cloudflare/issues/36) y [ADR-0010](../decisions/ADR-0010-crm-commercial-model.md); catálogo de servicios en [PR #45](https://github.com/LuisVR391/agent-cloudflare/pull/45) y el [módulo de pipelines](../modules/pipelines.md) |
